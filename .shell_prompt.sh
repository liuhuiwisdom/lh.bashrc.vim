...
function __promptline {
  ...
  local a_bg="${wrap}48;5;55${end_wrap}"
  local a_sep_fg="${wrap}38;5;55${end_wrap}"
  local b_fg="${wrap}38;5;15${end_wrap}"
  local b_bg="${wrap}48;5;98${end_wrap}"
  local b_sep_fg="${wrap}38;5;98${end_wrap}"
  ...
  local y_bg="${wrap}48;5;98${end_wrap}"
  local y_sep_fg="${wrap}38;5;98${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
