...
" let g:DoxygenToolkit_blockFooter="----------------------------------------------------------------------------"
 let g:DoxygenToolkit_authorName="\tYuwei Fan   <dawanzhi@163.com>"
...
function! <SID>DoxygenLicenseFunc()
  ...
  if !exists("g:DoxygenToolkit_authorName")
    ...
    let g:DoxygenToolkit_authorName = "ywfan"
  endif
  mark d
...
""""""""""""""""""""""""""
" Doxygen endfile comment
""""""""""""""""""""""""""
function! <SID>DoxygenEndfileFunc()
  call s:InitializeParameters()

  " Get file name
  let l:fileName = expand('End of file')

  " Begin to write skeleton
  let l:insertionMode = s:StartDocumentationBlock()
  exec "normal ".l:insertionMode.s:interCommentTag.l:fileName
  "exec "normal o".s:interCommentTag.g:DoxygenToolkit_versionTag.g:DoxygenToolkit_versionString
  mark d
  if ( g:DoxygenToolkit_endCommentTag != "" )
    exec "normal o".s:endCommentTag
...
command! -nargs=0 DoxA :call <SID>DoxygenAuthorFunc()
command! -nargs=0 DoxE :call <SID>DoxygenEndfileFunc()
